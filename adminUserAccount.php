<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        elseif (isset($_POST['uSubmit'])) {
            ...
            $useraccountid = isset($_POST['user-id']) ? $_POST['user-id'] : '';
            $usersGender = isset($_POST['user-gender']) ? $_POST['user-gender'] : '';
            $usersAddress = isset($_POST['user-address']) ? $_POST['user-address'] : '';
            $usersFName = isset($_POST['user-first-name']) ? $_POST['user-first-name'] : '';
            $usersMName = isset($_POST['user-middle-name']) ? $_POST['user-middle-name'] : '';
            $usersLName = isset($_POST['user-last-name']) ? $_POST['user-last-name'] : '';
            $usersSuffix = isset($_POST['user-suffix']) ? $_POST['user-suffix'] : '';
            $usersPNumber = isset($_POST['user-pnumber']) ? $_POST['user-pnumber'] : '';
            $usersSchoolID = isset($_POST['user-school-id']) ? $_POST['user-school-id'] : '';
            $userpfpfilepath = isset($_POST['userpfpfilepath']) ? $_POST['userpfpfilepath'] : '';
            ...
            // Role-specific data with isset checks
            $studentData = [
                'student_department' => isset($_POST['student-department']) ? $_POST['student-department'] : '',
            ...
            $adminData = [
                'admin_authority_level' => isset($_POST['admin-authority-level']) ? $_POST['admin-authority-level'] : ''
            ];
            // General user update query
            $userUpdateQuery = "
                UPDATE `user` 
                SET 
                    `user_img` = ?, 
